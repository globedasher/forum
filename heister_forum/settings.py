"""
Django settings for heister_forum project.
...
SECRET_KEY = 'hn2#i9x@mesn7w_1gduys#mv@()#w0cqej)6$*7v(uwlznd!us'
...
ROOT_URLCONF = 'heister_forum.urls'
...
WSGI_APPLICATION = 'heister_forum.wsgi.application'
